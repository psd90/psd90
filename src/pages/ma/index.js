...
const Ma = () => {
    return (
        ...
        <p> This was a pair programming project in which we created a single page application makes use of a NASA API that stores information of meteorite landings.<br /><br />
